    ...
    <div className='bg-white'>
        <h1 className=" h-[300px] text-white font-bold md:text-4xl text-2xl  md:p-[70px] p-[80px] mx-auto " style={{ backgroundImage: `url(${abtt})`, backgroundSize: 'cover', backgroundPosition: 'center', }}>
            ...
            <div className=' border-indigo-200'>
                <h1 className='text-center bg-indigo-300  border-indigo-200 sm:w-[500px] mt-8 text-2xl mx-auto'>Our fundamental identity revolves around continual growth, 
                    <br/>flexibility, and promoting good content.</h1>


                    <p className='p-1 pt-5 md:p-6'>Providing insightful content to bajzers, and potential bajzer to move the blog forward.
            ...
            <div className='mt-5 lg:flex-row-reverse lg:flex space-y-7 p-3'>
